...
<section class="ps-coa-current-path" aria-label="<?php esc_attr_e( 'Batch status and next step', 'pepselect-coa-archive' ); ?>">
	...
	<p><?php echo esc_html( 'approved' === $test['coa_status'] && ! $test['is_current'] ? __( 'This report covers a past batch. The product page shows current availability.', 'pepselect-coa-archive' ) : __( 'Match this report to the batch code on your vial.', 'pepselect-coa-archive' ) ); ?></p></div>
