...
<dl class="ps-coa-batch-meta">
	...
	<?php if ( $test['vial_cap_color'] ) : ?><div class="ps-coa-meta-cap"><dt><?php esc_html_e( 'Cap', 'pepselect-coa-archive' ); ?></dt><dd><?php echo esc_html( $test['vial_cap_color'] ); ?></dd></div><?php endif; ?>
	...
	<?php if ( $test['vial_crimp_color'] ) : ?><div class="ps-coa-meta-crimp"><dt><?php esc_html_e( 'Crimp', 'pepselect-coa-archive' ); ?></dt><dd><?php echo esc_html( $test['vial_crimp_color'] ); ?></dd></div><?php endif; ?>
</dl>
