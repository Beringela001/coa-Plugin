	...
	<ul class="ps-coa-qc-strip__categories">
		<?php foreach ( $test['qc_strip_rows'] as $row ) : ?>
			...
			<li class="ps-coa-qc-category ps-coa-qc-category--<?php echo esc_attr( $state ); ?>">
				...
				<span class="ps-coa-qc-category__copy"><strong><?php echo esc_html( $row['short_label'] ); ?></strong><span class="screen-reader-text"><?php echo esc_html( $row['status']['label'] ); ?></span></span>
			</li>
		<?php endforeach; ?>
	</ul>
</div>
