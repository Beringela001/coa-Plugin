...
<main class="ps-coa ps-coa-app ps-coa-history" id="ps-coa-main">
	...
	<?php if ( ! empty( $ps_context['incoming_reports'] ) ) : ?><section class="ps-coa-section" aria-labelledby="ps-incoming-reports"><div class="ps-coa-section-heading"><p class="ps-coa-eyebrow"><?php esc_html_e( 'Active batch vetting', 'pepselect-coa-archive' ); ?></p><h2 id="ps-incoming-reports"><?php esc_html_e( 'Incoming Reports', 'pepselect-coa-archive' ); ?></h2></div><div class="ps-coa-incoming-grid"><?php foreach ( $ps_context['incoming_reports'] as $report ) { include pepselect_coa_template_path( 'partials/incoming-report-card.php' ); } ?></div></section><?php endif; ?>
	<section class="ps-coa-section" aria-labelledby="ps-previous-reports"><div class="ps-coa-section-heading"><p class="ps-coa-eyebrow"><?php esc_html_e( 'Complete transparent record', 'pepselect-coa-archive' ); ?></p><h2 id="ps-previous-reports"><?php esc_html_e( 'Previous Reports', 'pepselect-coa-archive' ); ?></h2></div>
