...
<main class="ps-coa ps-coa-app ps-coa-history ps-coa-history--mockup-layout" id="ps-coa-main">
	...
	<section class="ps-coa-history-section" aria-labelledby="ps-history-latest">
		<header class="ps-coa-history-section__heading"><p class="ps-coa-eyebrow"><?php esc_html_e( 'Current documented release', 'pepselect-coa-archive' ); ?></p><h2 id="ps-history-latest"><?php echo esc_html( \PepSelect\COAArchive\Design_Settings::copy( 'latest_label' ) ); ?></h2></header>
	...
	<section class="ps-coa-history-section" aria-labelledby="ps-history-incoming">
		<header class="ps-coa-history-section__heading"><p class="ps-coa-eyebrow"><?php esc_html_e( 'Active batch vetting', 'pepselect-coa-archive' ); ?></p><h2 id="ps-history-incoming"><?php echo esc_html( \PepSelect\COAArchive\Design_Settings::copy( 'incoming_heading' ) ); ?></h2></header>
	...
	<section class="ps-coa-history-section ps-coa-history-section--previous" aria-labelledby="ps-history-previous">
		<header class="ps-coa-history-section__heading ps-coa-history-section__heading--split"><div><p class="ps-coa-eyebrow"><?php esc_html_e( 'Complete transparent record', 'pepselect-coa-archive' ); ?></p><h2 id="ps-history-previous"><?php echo esc_html( \PepSelect\COAArchive\Design_Settings::copy( 'previous_heading' ) ); ?></h2></div><p><?php esc_html_e( 'Previous batch records remain available so each documented release can be reviewed independently. Retention of historical records is part of Pep Select’s testing policy.', 'pepselect-coa-archive' ); ?></p></header>
