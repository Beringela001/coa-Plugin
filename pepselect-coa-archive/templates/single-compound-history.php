...
<main class="ps-coa ps-coa-app ps-coa-history" id="ps-coa-main">
	...
	<header class="ps-coa-history-header">
		...
		<div class="ps-coa-history-header__content">
			...
			<p class="ps-coa-history-header__latest"><?php echo esc_html( sprintf( __( 'Latest report: %s', 'pepselect-coa-archive' ), $ps_context['latest_report']['test_date_label'] ?: __( 'Not available', 'pepselect-coa-archive' ) ) ); ?></p>
		</div>
	</header>
