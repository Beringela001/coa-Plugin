...
final class Rewrites {
	...
	public function register() {
		...
		add_rewrite_rule( '^testing/?$', 'index.php?ps_coa_view=archive', 'top' );
		add_rewrite_rule( '^testing/([^/]+)/?$', 'index.php?ps_coa_view=compound&ps_compound_slug=$matches[1]', 'top' );
		add_rewrite_rule( '^testing/([^/]+)/([^/]+)/?$', 'index.php?ps_coa_view=report&ps_compound_slug=$matches[1]&ps_batch_slug=$matches[2]', 'top' );
	}
