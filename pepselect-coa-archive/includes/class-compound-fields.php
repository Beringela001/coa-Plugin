...
final class Compound_Fields {
	...
	private function base_fields() {
		return array(
			...
			$this->field( 'field_ps_compound_is_active', 'is_active', __( 'Active', 'pepselect-coa-archive' ), 'true_false', array( 'default_value' => 1, 'ui' => 1, 'instructions' => __( 'Controls whether this compound is eligible to appear publicly in the COA archive and Vetting History pages. Turning it off does not delete its tests or reports.', 'pepselect-coa-archive' ) ) ),
			$this->field( 'field_ps_compound_is_featured', 'is_featured', __( 'Featured', 'pepselect-coa-archive' ), 'true_false', array( 'default_value' => 0, 'ui' => 1, 'instructions' => __( 'Gives this compound priority placement in supported archive or promotional sections. Featured does not control whether the compound is publicly visible.', 'pepselect-coa-archive' ) ) ),
