...
final class COA_Test_Validation {
	...
	public function validate( $valid, $value, $field, $input ) {
		...
		$lengths = array( 'internal_batch_id' => 120, 'other_testing_lab' => 120, 'lab_accession_number' => 120, 'sample_appearance' => 200, 'purity_method' => 120, 'identity_method' => 120, 'endotoxin_result' => 120, 'endotoxin_unit' => 50, 'heavy_metals_summary' => 500, 'sterility_result' => 200, 'bioburden_result' => 200, 'residual_solvents_result' => 500, 'verification_code' => 200, 'certificate_version' => 50, 'public_notes' => 1000, 'report_notes' => 1000 );
		...
		if ( in_array( $name, array( 'test_date', 'date_received' ), true ) && '' !== $raw && ! $this->valid_date( $raw ) ) { return __( 'Enter a valid date.', 'pepselect-coa-archive' ); }
		if ( 'testing_lab' === $name && ! array_key_exists( $raw, COA_Test_Fields::labs() ) ) { return __( 'Select a valid testing laboratory.', 'pepselect-coa-archive' ); }
		...
		if ( 'vials_tested' === $name && ( false === filter_var( $raw, FILTER_VALIDATE_INT ) || (int) $raw < 1 ) ) { return __( 'Vials Tested must be a whole number of at least 1.', 'pepselect-coa-archive' ); }
	...
	/** Validates a Y-m-d date. @param string $date Date. @return bool */
	private function valid_date( $date ) { $parsed = \DateTimeImmutable::createFromFormat( '!Y-m-d', $date ); return $parsed && $parsed->format( 'Y-m-d' ) === $date; }
	...
	private static function result_fields() { return array( 'purity_status', 'identity_status', 'endotoxin_status', 'heavy_metals_status', 'sterility_status', 'bioburden_status', 'residual_solvents_status' ); }
	/** Maps stable ACF keys to stored names. @return array */
	private static function field_map() { return array( 'field_ps_coa_test_compound_id' => 'compound_id', 'field_ps_coa_test_batch_number' => 'batch_number', 'field_ps_coa_test_internal_batch_id' => 'internal_batch_id', 'field_ps_coa_test_test_date' => 'test_date', 'field_ps_coa_test_date_received' => 'date_received', 'field_ps_coa_test_testing_lab' => 'testing_lab', 'field_ps_coa_test_other_testing_lab' => 'other_testing_lab', 'field_ps_coa_test_lab_accession_number' => 'lab_accession_number', 'field_ps_coa_test_status' => 'coa_status', 'field_ps_coa_test_is_current' => 'is_current', 'field_ps_coa_test_claimed_content' => 'claimed_content', 'field_ps_coa_test_content_unit' => 'content_unit', 'field_ps_coa_test_vials_submitted' => 'vials_submitted', 'field_ps_coa_test_vials_tested' => 'vials_tested', 'field_ps_coa_test_average_net_content' => 'average_net_content', 'field_ps_coa_test_minimum_net_content' => 'minimum_net_content', 'field_ps_coa_test_maximum_net_content' => 'maximum_net_content', 'field_ps_coa_test_net_content_std_dev' => 'net_content_std_dev', 'field_ps_coa_test_content_variance_percent' => 'content_variance_percent', 'field_ps_coa_test_sample_appearance' => 'sample_appearance', 'field_ps_coa_test_purity_percentage' => 'purity_percentage', 'field_ps_coa_test_purity_status' => 'purity_status', 'field_ps_coa_test_purity_method' => 'purity_method', 'field_ps_coa_test_identity_status' => 'identity_status', 'field_ps_coa_test_identity_method' => 'identity_method', 'field_ps_coa_test_endotoxin_status' => 'endotoxin_status', 'field_ps_coa_test_endotoxin_result' => 'endotoxin_result', 'field_ps_coa_test_endotoxin_unit' => 'endotoxin_unit', 'field_ps_coa_test_heavy_metals_status' => 'heavy_metals_status', 'field_ps_coa_test_heavy_metals_summary' => 'heavy_metals_summary', 'field_ps_coa_test_sterility_status' => 'sterility_status', 'field_ps_coa_test_sterility_result' => 'sterility_result', 'field_ps_coa_test_bioburden_status' => 'bioburden_status', 'field_ps_coa_test_bioburden_result' => 'bioburden_result', 'field_ps_coa_test_residual_solvents_status' => 'residual_solvents_status', 'field_ps_coa_test_residual_solvents_result' => 'residual_solvents_result', 'field_ps_coa_test_coa_pdf_id' => 'coa_pdf_id', 'field_ps_coa_test_page_images' => 'coa_page_images', 'field_ps_coa_test_lab_verification_url' => 'lab_verification_url', 'field_ps_coa_test_lab_report_url' => 'lab_report_url', 'field_ps_coa_test_verification_code' => 'verification_code', 'field_ps_coa_test_certificate_version' => 'certificate_version', 'field_ps_coa_test_public_notes' => 'public_notes', 'field_ps_coa_test_report_notes' => 'report_notes', 'field_ps_coa_test_internal_notes' => 'internal_notes' ); }
}
