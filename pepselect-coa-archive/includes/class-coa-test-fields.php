...
final class COA_Test_Fields {
	...
	private function fields() {
		...
		return array(
			...
			$this->f( 'sample_appearance', 'Sample Appearance', 'text', array( 'maxlength' => 200 ) ),
			...
			$this->result( 'endotoxin_status', 'Endotoxin Status', 'not-tested', $result ),
			$this->f( 'endotoxin_result', 'Endotoxin Result', 'text', array( 'maxlength' => 120 ) ),
			$this->f( 'endotoxin_unit', 'Endotoxin Unit', 'text', array( 'maxlength' => 50 ) ),
			$this->result( 'heavy_metals_status', 'Heavy Metals Status', 'not-tested', $result ),
			$this->f( 'heavy_metals_summary', 'Heavy Metals Summary', 'textarea', array( 'rows' => 3, 'maxlength' => 500 ) ),
			$this->result( 'sterility_status', 'Sterility Status', 'not-tested', $result ),
			$this->f( 'sterility_result', 'Sterility Result', 'text', array( 'maxlength' => 200 ) ),
			$this->result( 'bioburden_status', 'Bioburden Status', 'not-tested', $result ),
			$this->f( 'bioburden_result', 'Bioburden Result', 'text', array( 'maxlength' => 200 ) ),
			$this->result( 'residual_solvents_status', 'Residual Solvents Status', 'not-tested', $result ),
			$this->f( 'residual_solvents_result', 'Residual Solvents Result', 'text', array( 'maxlength' => 500 ) ),
			...
			$this->f( 'lab_report_url', 'Lab Report URL', 'url' ),
			$this->f( 'verification_code', 'Verification Code', 'text', array( 'maxlength' => 200 ) ),
	...
	public static function result_choices() { return array( 'pass' => 'Pass', 'fail' => 'Fail', 'pending' => 'Pending', 'not-tested' => 'Not Tested', 'not-applicable' => 'Not Applicable' ); }
