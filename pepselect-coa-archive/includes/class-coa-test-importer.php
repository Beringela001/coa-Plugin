...
final class COA_Test_Importer {
	...
	private function field_map() {
		$names = array( 'compound_id', 'batch_number', 'internal_batch_id', 'test_date', 'expected_coa_date', 'date_received', 'testing_lab', 'other_testing_lab', 'lab_accession_number', 'is_current', 'vial_crimp_color', 'vial_crimp_color_other', 'vial_cap_color', 'vial_cap_color_other', 'claimed_content', 'content_unit', 'vials_submitted', 'vials_tested', 'average_net_content', 'minimum_net_content', 'maximum_net_content', 'net_content_std_dev', 'content_variance_percent', 'sample_appearance', 'purity_percentage', 'purity_status', 'purity_method', 'identity_status', 'identity_method', 'endotoxin_status', 'endotoxin_result', 'endotoxin_unit', 'heavy_metals_status', 'heavy_metals_summary', 'sterility_status', 'sterility_result', 'coa_number', 'lab_report_url', 'pending_lab_url', 'verification_code', 'lab_verification_url', 'certificate_version', 'public_notes', 'report_notes', 'internal_notes' );
