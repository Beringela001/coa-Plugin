...
final class Design_Settings {
	...
	public static function fields() {
		...
		$copy = array(
			...
			'vendor_vetting_label' => array( 'Vetting-vendor label', 'Vetting Vendor' ), 'vendor_vetting_copy' => array( 'Vetting-vendor copy', 'We’re sourcing a new batch from a vetted manufacturer.' ),
			'waiting_vendor_label' => array( 'Waiting-vendor label', 'Waiting on Vendor' ), 'waiting_vendor_copy' => array( 'Waiting-vendor copy', 'A new batch is on its way to us.' ),
			'submitted_lab_label' => array( 'Submitted-to-lab label', 'Submitted to Laboratory' ), 'submitted_lab_copy' => array( 'Submitted-to-lab copy', 'Samples are with the lab.' ),
			'in_testing_label' => array( 'In-testing label', 'Verification in Progress' ), 'in_testing_copy' => array( 'In-testing copy', 'Testing is underway.' ),
