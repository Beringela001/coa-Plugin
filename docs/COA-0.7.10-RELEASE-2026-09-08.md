...
GitHub publication of the approved COA branch was explicitly authorized for this release. Version and release evidence are committed with the approved source. No merge to main is part of this release.
