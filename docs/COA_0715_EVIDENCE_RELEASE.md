...
Owner installed 0.7.15. Anonymous normal-URL verification passed for https://pepselect.com/testing/kpv-10-mg/kp1026246jp/: desktop table and 390px mobile cards show Immunoassay, Immunoassay, 50 ng/mL cutoff, Not detected, Pass. Heavy metals and endotoxins rows absent. Purity 99.96%, measured content 10.68 mg and sterility No Detectable Microbial DNA unchanged. Original laboratory and hosted PDF links retained. Mobile page reports 383px content versus 375px client width; no claim of zero page overflow. Viewport override reset. No Control image rebuild or deployment needed.

0.7.15 includes prior green-tested 0.7.14 pending-vial-count fix. Browser automated file selection repeatedly stalled despite enabled file permissions; owner performed installation. Public verification required no cache workaround or cache-busting URL.
